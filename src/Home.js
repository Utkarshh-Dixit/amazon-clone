    ...
    <div className='home'>
       <div className='home_container'>
        ...
        <div className='home_row'>
          <Product id="12345" title="The Lean Startup (How Constant Innovation Creates Radically Successful Businesses)" price={88.88} image="https://images-na.ssl-images-amazon.com/images/I/51Zymoq7UnL._AC_SY400_.jpg" rating={3}/>
